...
class GenericWeaponComponent : GKComponent {
    ...
    func setDamage(damage: CGFloat) {
        self.damage = damage
    }
    
    func setDamageRate(damageRate: CGFloat) {
        self.damageRate = damageRate
    }
    
    func setDamageRange(damageRange: CGFloat) {
