    ...
    override func tick() {
        ...
        if power_current < Structure.ReactorValues.power_capacity[level]
        {
            ...
            if power_current > Structure.ReactorValues.power_capacity[level] {
                ...
                gameScene.power_add(toAdd: Structure.ReactorValues.power_provided[level] - powerOver)
                power_current = Structure.ReactorValues.power_capacity[level]
            }
            else {
                gameScene.power_add(toAdd: Structure.ReactorValues.power_provided[level])
            }
...
//        print("My power is: \(power_current)")
    ...
    override func didFinishConstruction() {
        ...
        gameScene.player_powerCapacity += Structure.ReactorValues.power_capacity[level]
